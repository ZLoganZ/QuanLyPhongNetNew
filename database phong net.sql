...
create table TransactionDiary
(
	UserName nvarchar(60) references TheUser(UserName),
	memberID int references Member(memberID),
	TransacDate date,
	AddTime time,
	AddMoney float,
...
(
	...
	FoundedUser nvarchar(60) references TheUser(UserName),
	FoundedDate date,
	PriceTotal float,
)
...
--Nguoi Dung
insert into TheUser values (N'Hoàng Phúc','Manager',N'Quản lý','0961563202','heavenhell8899@gmail.com')
insert into TheUser values (N'Huyền Trang','Staff',N'Nhân viên','0123456789','trang@gmail.com')
insert into TheUser values (N'Văn Tiến','Staff',N'Nhân viên','097851364','tien@gmail.com')
